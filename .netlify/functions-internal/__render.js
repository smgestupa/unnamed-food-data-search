...
var food_data = writable2({});
var loading_animation = "src/assets/loading-animation.gif";
...
var NoResults = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { term = "" } = $$props;
  ...
  return `<div class="${"flex justify-center text-center mt-40"}"><div class="${"text-gray-300"}"><i class="${"fas fa-exclamation-triangle text-9xl text-red-500"}"></i>
        <div class="${"mt-8"}"><h3 class="${"text-xl"}">Sorry! No results found using <span class="${"text-white"}">${escape2(term)}</span> from the database.
            </h3></div></div></div>`;
});
...
var FirstTime = create_ssr_component(($$result, $$props, $$bindings, slots) => {
